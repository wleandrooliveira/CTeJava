 ...
 */
package br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao;
...
//    
//     */
//    public br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteRecepcaoLoteResult cteRecepcaoLote(
//            br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteDadosMsg cteDadosMsg0, br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteCabecMsgE cteCabecMsg1)
...
//                    br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteRecepcaoLoteResult.class,
//                    getEnvelopeNamespaces(_returnEnv));
//
//
//            return (br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteRecepcaoLoteResult) object;
//
...
//            br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteDadosMsg cteDadosMsg0, br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteCabecMsgE cteCabecMsg1,
//            final br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoCallbackHandler callback)
//            throws java.rmi.RemoteException {
//
//        org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
//        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao/cteRecepcaoLote");
...
//                            (br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteRecepcaoLoteResult) object);
//
...
//    }
//
//    private org.apache.axiom.om.OMElement toOM(br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteDadosMsg param, boolean optimizeContent)
//            throws org.apache.axis2.AxisFault {
//
//
//        try {
//            return param.getOMElement(br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteDadosMsg.MY_QNAME,
...
//    }
//
//    private org.apache.axiom.om.OMElement toOM(br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteRecepcaoLoteResult param, boolean optimizeContent)
//            throws org.apache.axis2.AxisFault {
//
//
//        try {
//            return param.getOMElement(br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteRecepcaoLoteResult.MY_QNAME,
//                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
//        } catch (org.apache.axis2.databinding.ADBException e) {
//            throw org.apache.axis2.AxisFault.makeFault(e);
//        }
...
//    }
//
//    private org.apache.axiom.om.OMElement toOM(br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteCabecMsgE param, boolean optimizeContent)
//            throws org.apache.axis2.AxisFault {
//
//
//        try {
//            return param.getOMElement(br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteCabecMsgE.MY_QNAME,
//                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
//        } catch (org.apache.axis2.databinding.ADBException e) {
//            throw org.apache.axis2.AxisFault.makeFault(e);
//        }
...
//    }
//
//    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteDadosMsg param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
//            throws org.apache.axis2.AxisFault {
//
//
//        try {
...
//            emptyEnvelope.getBody().addChild(param.getOMElement(br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteDadosMsg.MY_QNAME, factory));
...
//        try {
//
//            if (br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteDadosMsg.class.equals(type)) {
//
//                return br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
//
//
//            }
//
//            if (br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteRecepcaoLoteResult.class.equals(type)) {
//
//                return br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteRecepcaoLoteResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
//
//
//            }
//
//            if (br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteCabecMsgE.class.equals(type)) {
//
//                return br.com.moveti.erpmove.transporte.cte.comunicacao.Recepcao.CteRecepcaoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
//
//
//            }
//
