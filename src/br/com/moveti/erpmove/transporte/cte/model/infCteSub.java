...
public class infCteSub {
     ...
     * @param 
     */
    public void setTomaICMS(br.com.moveti.erpmove.transporte.cte.model.tomaICMS tomaICMS) {
     ...
     * @param 
     */
    public void setTomaNaoICMS(br.com.moveti.erpmove.transporte.cte.model.tomaNaoICMS tomaNaoICMS) {
    ...
    public br.com.moveti.erpmove.transporte.cte.model.tomaICMS getTomaICMS() {
        return tomaICMS;
    }

    public br.com.moveti.erpmove.transporte.cte.model.tomaNaoICMS getTomaNaoICMS() {
        return tomaNaoICMS;
    }
}
