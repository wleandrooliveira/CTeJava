...
public class infUnidTransp {
     ...
     * @param 
     */
    public void setLacUnidTransp(List<br.com.moveti.erpmove.transporte.cte.model.lacUnidTransp> lacUnidTransp) {
     ...
     * @param 
     */
    public void setInfUnidCarga(List<br.com.moveti.erpmove.transporte.cte.model.infUnidCarga> infUnidCarga) {
    ...
    public List<br.com.moveti.erpmove.transporte.cte.model.infUnidCarga> getInfUnidCarga() {
        return infUnidCarga;
    }

    public List<br.com.moveti.erpmove.transporte.cte.model.lacUnidTransp> getLacUnidTransp() {
