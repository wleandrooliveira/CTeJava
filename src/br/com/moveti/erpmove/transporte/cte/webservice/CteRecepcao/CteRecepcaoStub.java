 ...
 */
package br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao;
...
public class CteRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public CteRecepcaoStub(org.apache.axis2.context.ConfigurationContext configurationContext) throws org.apache.axis2.AxisFault {
        ...
        this(configurationContext, "https://hcte.fazenda.mg.gov.br/cte/services/CteRecepcao");
    ...
    public CteRecepcaoStub() throws org.apache.axis2.AxisFault {
        ...
        this("https://hcte.fazenda.mg.gov.br/cte/services/CteRecepcao");
     ...
     * @see br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcao#cteRecepcaoLote
     * @param cteDadosMsg0
    
     * @param cteCabecMsg1
    
     */
    public br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteRecepcaoLoteResult cteRecepcaoLote(
            br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteDadosMsg cteDadosMsg0, br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteCabecMsgE cteCabecMsg1)
        ...
        try {
            ...
            java.lang.Object object = fromOM(
                    ...
                    br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteRecepcaoLoteResult.class,
                    getEnvelopeNamespaces(_returnEnv));


            return (br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteRecepcaoLoteResult) object;
     ...
     * Transmissão de Lote de CT-e
     * @see br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcao#startcteRecepcaoLote
     * @param cteDadosMsg0
    ...
    public void startcteRecepcaoLote(
            br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteDadosMsg cteDadosMsg0, br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteCabecMsgE cteCabecMsg1,
            final br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoCallbackHandler callback)
            throws java.rmi.RemoteException {
            ...
            public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    callback.receiveResultcteRecepcaoLote(
                            (br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteRecepcaoLoteResult) object);
    ...
    public static class ExtensionMapper {
        ...
        public static java.lang.Object getTypeObject(java.lang.String namespaceURI,
            ...
            if ("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao".equals(namespaceURI)
        ...
        public org.apache.axiom.om.OMElement getOMElement(
            ...
            org.apache.axiom.om.OMDataSource dataSource =
                    new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
                        ...
                        public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                            CteRecepcaoLoteResult.this.serialize(MY_QNAME, factory, xmlWriter);
                        }
                    };
            return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(
                    MY_QNAME, factory, dataSource);
    ...
    private org.apache.axiom.om.OMElement toOM(br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteDadosMsg param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {


        try {
            return param.getOMElement(br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteDadosMsg.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    ...
    private org.apache.axiom.om.OMElement toOM(br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteRecepcaoLoteResult param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {


        try {
            return param.getOMElement(br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteRecepcaoLoteResult.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteCabecMsgE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {


        try {
            return param.getOMElement(br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteCabecMsgE.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteDadosMsg param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {
        ...
        try {
            ...
            emptyEnvelope.getBody().addChild(param.getOMElement(br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(
        ...
        try {
            ...
            if (br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteDadosMsg.class.equals(type)) {

                return br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());


            }

            if (br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteRecepcaoLoteResult.class.equals(type)) {

                return br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteRecepcaoLoteResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());


            }

            if (br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteCabecMsgE.class.equals(type)) {

                return br.com.moveti.erpmove.transporte.cte.webservice.CteRecepcao.CteRecepcaoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
