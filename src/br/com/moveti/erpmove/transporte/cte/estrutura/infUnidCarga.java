...
public class infUnidCarga {
     ...
     * @param 
     */
    public void setLacUnidCarga(List<br.com.moveti.erpmove.transporte.cte.estrutura.lacUnidCarga> lacUnidCarga) {
    ...
    public List<br.com.moveti.erpmove.transporte.cte.estrutura.lacUnidCarga> getLacUnidCarga() {
        return lacUnidCarga;
    }
