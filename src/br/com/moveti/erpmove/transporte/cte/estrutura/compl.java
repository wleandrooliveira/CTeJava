...
public class compl {
     ...
     * @param 
     */
    public void setFluxo(br.com.moveti.erpmove.transporte.cte.estrutura.fluxo fluxo) {
        this.fluxo = fluxo;
    }
     ...
     * @param 
     */
    public void setEntrega(br.com.moveti.erpmove.transporte.cte.estrutura.Entrega Entrega) {
     ...
     * @param 
     */
    public void setObsCont(List<br.com.moveti.erpmove.transporte.cte.estrutura.ObsCont> ObsCont) {
     ...
     * @param 
     */
    public void setObsFisco(List<br.com.moveti.erpmove.transporte.cte.estrutura.ObsFisco> ObsFisco) {
        this.ObsFisco = ObsFisco;
    }

    public br.com.moveti.erpmove.transporte.cte.estrutura.Entrega getEntrega() {
        return Entrega;
    }

    public List<br.com.moveti.erpmove.transporte.cte.estrutura.ObsCont> getObsCont() {
        return ObsCont;
    }

    public List<br.com.moveti.erpmove.transporte.cte.estrutura.ObsFisco> getObsFisco() {
        return ObsFisco;
    }
    ...
    public br.com.moveti.erpmove.transporte.cte.estrutura.fluxo getFluxo() {
        return fluxo;
    }
