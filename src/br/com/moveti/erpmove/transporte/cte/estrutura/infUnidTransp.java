...
public class infUnidTransp {
     ...
     * @param 
     */
    public void setLacUnidTransp(List<br.com.moveti.erpmove.transporte.cte.estrutura.lacUnidTransp> lacUnidTransp) {
     ...
     * @param 
     */
    public void setInfUnidCarga(List<br.com.moveti.erpmove.transporte.cte.estrutura.infUnidCarga> infUnidCarga) {
    ...
    public List<br.com.moveti.erpmove.transporte.cte.estrutura.infUnidCarga> getInfUnidCarga() {
        return infUnidCarga;
    }

    public List<br.com.moveti.erpmove.transporte.cte.estrutura.lacUnidTransp> getLacUnidTransp() {
