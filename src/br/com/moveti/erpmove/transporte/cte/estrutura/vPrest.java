...
public class vPrest {
     ...
     * @param 
     */
    public void setComp(List<br.com.moveti.erpmove.transporte.cte.estrutura.Comp> Comp) {
        this.Comp = Comp;
    }

    public List<br.com.moveti.erpmove.transporte.cte.estrutura.Comp> getComp() {
        return Comp;
    }
